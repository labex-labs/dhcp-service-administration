...
<p align="center">
  <a href="https://labex.io/zh/courses/dhcp-service-administration">
    <img src="https://course-cover.labex.io/dhcp-service-administration.png?lang=zh" alt="DHCP 服务管理">
  </a>
</p>

学习 DHCP 服务管理。本模块涵盖安装 ISC DHCP 服务器、配置子网范围、固定 IP 预留、分析租约、DHCP 故障排除。您将通过实践实验室和真实世界的挑战掌握这些基本的 Linux 技能。

[在 LabEx 开始课程](https://labex.io/zh/courses/dhcp-service-administration)
